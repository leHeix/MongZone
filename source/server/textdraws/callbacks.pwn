...
hook OnPlayerConnect(playerid)
{
	...
	for(new i = 2; i != -1; i -= 1)
	{
		...
		PlayerTextDrawSetOutline(playerid, p_tdNotifications[playerid][i]{5}, 1);
		PlayerTextDrawSetShadow(playerid, p_tdNotifications[playerid][i]{5}, 0);
		PlayerTextDrawAlignment(playerid, p_tdNotifications[playerid][i]{5}, 1);
		PlayerTextDrawColor(playerid, p_tdNotifications[playerid][i]{5}, -741092463);
		PlayerTextDrawBackgroundColor(playerid, p_tdNotifications[playerid][i]{5}, 336860220);
		PlayerTextDrawBoxColor(playerid, p_tdNotifications[playerid][i]{5}, 50);
		PlayerTextDrawUseBox(playerid, p_tdNotifications[playerid][i]{5}, 0);
		PlayerTextDrawSetProportional(playerid, p_tdNotifications[playerid][i]{5}, 1);
		PlayerTextDrawSetSelectable(playerid, p_tdNotifications[playerid][i]{5}, 0);
	}
